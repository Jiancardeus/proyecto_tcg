//#Importamos las carteris y les ponemos un nombre que el React busca despues el solito
import EspadachinSolar from './assets/cards/tropa_2.png'
import ReyPaladin from './assets/cards/tropa_4.png'
import SacerdoteSolar from './assets/cards/tropa_5.png'
import AlabarderoReal from './assets/cards/tropa_6.png'
import AvatarDeLaLuz from './assets/cards/tropa_9.png'
import MagoDeBatalla from './assets/cards/tropa_10.png'
import PortaEstandarte from './assets/cards/tropa_11.png'
import HeroeSolar from './assets/cards/heroe_1_1.png'

//#User ficticio para version Alpha-0.1
export const mockUser = {
    username: "IloveFemboyIssac",
    level: 5,
    avatar: AvatarDeLaLuz
}; 

//#Cartas para version Alpha-0.1, esto funciona como el catalago basicamente y aca balanceamos cartas 
...
export const mockCardCollection = [
...

    {
        ...
        image: AvatarDeLaLuz,
        faction: "Caballeros Solarees",
        description: "Estado permanente de DESLUMBRAR, no recibe daño de magias"
    },
    
];

//Mazo Prueba para version alp bla bla 

export const mockPlayerDecks = [
    {
        id: "deck1",
        name: "Mazo de la justicia",
        cards: ["CS001","CS001","CS002","CS003","CS007"]
    }
]
